...
library CentuariPrimeEventsLib {
    ...
    event SetSupplyQueue(address indexed curator, address indexed vault, uint256 index, VaultMarketSupplyConfig supplyQueue);
    event SetWithdrawQueue(address indexed curator, address indexed vault, uint256 index, VaultMarketWithdrawConfig withdrawQueue);
}
