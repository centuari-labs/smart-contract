...
library CentuariPrimeDSLib {
    ...
    bytes32 public constant SUPPLY_QUEUE = keccak256("SUPPLY_QUEUE");
    bytes32 public constant WITHDRAW_QUEUE = keccak256("WITHDRAW_QUEUE");
    ...
    function getSupplyQueueKey() internal pure returns (bytes32) {
        return SUPPLY_QUEUE;
    }
}
