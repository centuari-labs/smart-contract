...
/// @param lltv Liquidation Loan-to-Value ratio in 1e18 format (e.g., 75% = 75e16)
...
interface ILendingPool {
    ...
    /// @param bondToken Address of the BondToken contract for this borrow rate
    ...
    /// @notice Emitted when a new BondToken is created
    /// @param bondToken The address of the new BondToken
    /// @param borrowRate The borrow rate that was added
    event BondTokenCreated(address bondToken, uint256 borrowRate);
    ...
    /// @dev Creates a new BondToken contract for this borrow rate tier
    ...
    function setLltv(uint256 ltv_) external;
    ...
    /// @dev Only callable by the router contract. Mints BondTokens to the supplier.
    ...
    /// @dev Only callable after maturity. Burns BondTokens and transfers underlying assets.
